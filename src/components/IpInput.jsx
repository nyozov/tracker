...
function IpInput({ setIpInput, setLocation, fetchLocation}) {
  ...
  return (
    <div className='flex justify-center items-center w-screen flex-col '>
      ...
      <input required fontSize={18} onChange={handleInput} className='focus:outline-none px-4 rounded-l-2xl w-full shadow' minlength="7" maxlength="15" size="15" pattern="^((\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.){3}(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$"/>
